...
function Login({loading,error}:{loading:boolean;error:string}){
  ...
  const login=async()=>{
    ...
    if(!email.includes('@')){setMsg('請輸入 Email，舊帳號可輸入 keker');return}
    setBusy(true)
